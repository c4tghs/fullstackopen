...
describe('most likes', () => {
  ...
  test('of a bigger list is a favorite one', () => {
...
describe('most amount of blogs', () => {
  test('of empty list is no amount', () => {
  ...
  test('of a bigger list, an author has the most amount of blogs', () => {
...
describe('most amount of likes', () => {
  ...
  test('of a bigger list, an author has the most likes', () => {
